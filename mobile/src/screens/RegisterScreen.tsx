...
type RegisterNav = StackNavigationProp<NavigationParamList, 'Register'>;
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: C.cream }}>
      <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
        <ScrollView contentContainerStyle={[styles.container, { flex: 1, justifyContent: 'center' }]}>
          <Text style={[FONT.h1, { marginBottom: 8 }]}>Create Account</Text>
          <Text style={[FONT.body, { marginBottom: 40 }]}>Join Voyza and start driving</Text>
          ...
          {step === 1 ? (
            ...
            <>
              ...
              <Text style={{ marginTop: 16, alignSelf: 'center', color: C.orange, fontWeight: '600' }} onPress={() => setStep(1)}>
                Change number
              </Text>
            </>
          )}
