...
import {
  View, Text, ScrollView, SafeAreaView, TouchableOpacity, ActivityIndicator, Alert, StyleSheet,
} from 'react-native';
import { useNavigation } from '@react-navigation/native';
import { BottomTabNavigationProp } from '@react-navigation/bottom-tabs';
import { StackNavigationProp } from '@react-navigation/stack';
import { NavigationParamList, User } from '../types';
import { C, FONT } from '../constants/theme';
import { api } from '../api/client';
import { storage } from '../utils/storage';
import { Button } from '../components/Button';

type ProfileNav = BottomTabNavigationProp<NavigationParamList> & StackNavigationProp<NavigationParamList>;
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: C.cream }}>
      <ScrollView>
        <View style={styles.container}>
          ...
          {[
            { label: 'My Trips', icon: '📋', screen: 'Bookings' as const },
